(function (z) {
    var K = function (h, b, f, n) {
        ...
        c.make();
        n = n || 0;
        var p = c.getModuleCount(), v = c.getModuleCount() + 2 * n;
        this.text = h;
        this.level = b;
        this.version = f;
        this.moduleCount = v;
        ...
        this.addBlank = function (b, f, c, h) {
            var n = this.isDark, p = 1 / v;
            this.isDark = function (C, m) {
                var a = m * p, d = C * p, y = a + p, g = d + p;
    ...
    }(), L = "[object Opera]" !== Object.prototype.toString.call(window.opera), G = function (h, b, f, n, c) {
        f = Math.max(1, f || 1);
        ...
        var w = c + p;
        f = f.radius * p;
        var q = v - 1, z = v + 1, D = k - 1, C = k + 1, m = x(v, k), a = x(q, D);
        p = x(q, k);
        var d = x(q, C), q = x(v, C), C = x(z, C);
        k = x(z, k);
        z = x(z, D);
        v = x(v, D);
        ...
        if (!f) return null;
        var n = z(h).data("qrcode", f), c = n[0].getContext("2d");
        ...
        var p = b.mode;
        if (1 === p || 2 === p) {
            var p = b.size, v = "bold " + b.mSize * p + "px " + b.fontname, k = z("<canvas/>")[0].getContext("2d");
            k.font = v;
            var x = k.measureText(b.label).width, k = b.mSize, w = x / p, x = (1 -
                w) * b.mPosX, q = (1 - k) * b.mPosY, w = x + w, k = q + k;
            ...
            var p = b.size, v = b.mSize, k = v * (b.image.naturalWidth || 1) / (b.image.naturalHeight || 1),
                x = (1 - k) * b.mPosX, q = (1 - v) * b.mPosY, w = x + k, E = q + v;
        ...
        c.beginPath();
        for (x = 0; x < p; x += 1) for (q = 0; q < p; q += 1) k(f, c, b, b.left + q * v, b.top + x * v, v, x, q);
        ...
        if (b = G(h.text, h.ecLevel, h.minVersion, h.maxVersion, h.quiet)) {
            var f = h.size, n = h.background, c = Math.floor, p = b.moduleCount, v = c(f / p), c = c(.5 * (f - v * p)),
            ...
            for (n = 0; n < p; n += 1) for (k = 0; k < p; k += 1) b.isDark(n, k) && z("<div/>").css(h).css({
                left: c + k * v,
                top: c + n * v
            }).appendTo(f);
            b = f
    ...
    var J = function () {
        function h(b, f) {
            ...
            var a = function () {
                ...
                get: function (d) {
                    ...
                    for (var g = Array(d.getLength() + y.getLength() - 1), e = 0; e < d.getLength(); e += 1) for (var a = 0; a < y.getLength(); a += 1) g[e + a] ^= c.gexp(c.glog(d.get(e)) + c.glog(y.get(a)));
                    return h(g, 0)
                }, mod: function (y) {
        ...
        var b = function (b, c) {
            var a = f[c], d = null, y = 0, g = null, e = [], A = {}, B = function (A, f) {
                ...
                for (l = 0; l < r.length; l += 1) for (c = 0; c < r.length; c += 1) {
                    var m = r[l], B = r[c];
                    if (null == d[m][B]) for (var k = -2; 2 >= k; k += 1) for (var t = -2; 2 >= t; t += 1) d[m + k][B + t] = -2 == k || 2 == k || -2 == t || 2 == t || 0 == k && 0 == t ? !0 : !1
                }
                ...
                if (null == g) {
                    ...
                    for (var q = 0, m = c = 0, B = Array(r.length), k = Array(r.length), t = 0; t < r.length; t += 1) {
                        var w = r[t].dataCount, z = r[t].totalCount - w, c = Math.max(c, w), m = Math.max(m, z);
                        B[t] = Array(w);
                    ...
                    l = Array(l);
                    for (u = q = 0; u < c; u += 1) for (t = 0; t < r.length; t += 1) u < B[t].length && (l[q] = B[t][u], q += 1);
                    for (u = 0; u < m; u += 1) for (t = 0; t < r.length; t += 1) u < k[t].length && (l[q] = k[t][u], q += 1);
                    g = l
                }
                r = g;
                l = -1;
                ...
                for (var e = -1; 7 >= e; e += 1) if (!(-1 >= a + e || y <= a + e)) for (var b = -1; 7 >= b; b += 1) -1 >= g + b || y <= g + b || (d[a + e][g + b] = 0 <= e && 6 >= e && (0 == b || 6 == b) || 0 <= b && 6 >= b && (0 == e || 6 == e) || 2 <= e && 4 >= e && 2 <= b && 4 >= b ? !0 : !1)
            };
            ...
            A.createImgTag = function (e, d) {
                ...
                var a = A.getModuleCount() * e + 2 * d, g = d, b = a - d;
        ...
        b.createStringToBytes = function (b, c) {
            var a = function () {
                for (var d = q(b), a = function () {
                    ...
                    var A = d.read();
                    if (-1 == A) break;
                    var f = a(), h = a(), k = a(), A = String.fromCharCode(A << 8 | f);
                    e[A] = h << 8 | k;
                    g += 1
                }
        ...
        var f = {L: 1, M: 0, Q: 3, H: 2}, n = function () {
            ...
            m.getLostPoint = function (d) {
                ...
                for (e = 0; e < a - 1; e += 1) for (c = 0; c < a - 1; c += 1) if (m = 0, d.isDark(e, c) && (m += 1), d.isDark(e + 1, c) && (m += 1), d.isDark(e, c + 1) && (m += 1), d.isDark(e + 1, c + 1) && (m += 1), 0 == m || 4 == m) b += 3;
                for (e = 0; e < a; e += 1) for (c = 0; c < a - 6; c += 1) d.isDark(e, c) && !d.isDark(e, c + 1) && d.isDark(e, c + 2) && d.isDark(e, c + 3) && d.isDark(e, c + 4) && !d.isDark(e, c + 5) && d.isDark(e, c + 6) && (b += 40);
                for (c = 0; c < a; c += 1) for (e = 0; e < a - 6; e += 1) d.isDark(e, c) && !d.isDark(e + 1, c) && d.isDark(e + 2, c) && d.isDark(e + 3, c) && d.isDark(e + 4, c) && !d.isDark(e + 5, c) && d.isDark(e + 6, c) && (b += 40);
                for (c = m = 0; c < a; c += 1) for (e = 0; e < a; e += 1) d.isDark(e, c) && (m += 1);
            ...
            var b = [[1, 26, 19], [1, 26, 16], [1, 26, 13], [1, 26, 9], [1, 44, 34], [1, 44, 28], [1, 44, 22], [1, 44, 16], [1, 70, 55], [1, 70, 44], [2, 35, 17], [2, 35, 13], [1, 100, 80], [2, 50, 32], [2, 50, 24], [4, 25, 9], [1, 134, 108], [2, 67, 43], [2, 33, 15, 2, 34, 16], [2, 33, 11, 2, 34, 12], [2, 86, 68], [4, 43, 27], [4, 43, 19], [4, 43, 15], [2, 98
 73, 45, 23, 74, 46], [4, 54, 24, 31, 55, 25], [11, 45, 15, 31, 46, 16], [7, 146, 116, 7, 147, 117], [21, 73, 45, 7, 74, 46], [1, 53, 23, 37, 54, 24], [19, 45, 15, 26, 46, 16], [5, 145, 115, 10, 146, 116], [19, 75, 47, 10, 76, 48], [15, 54, 24, 25, 55, 25], [23, 45, 15, 25, 46, 16], [13, 145, 115, 3, 146, 116], [2, 74, 46, 29, 75, 47], [42, 54, 24, 1, 55, 25], [23, 45, 15, 28, 46, 16], [17, 145, 115], [10, 74, 46, 23, 75, 47], [10, 54, 24, 35, 55, 25], [19, 45, 15, 35, 46, 16], [17, 145, 115, 1, 146, 116], [14, 74, 46, 21, 75, 47], [29, 54, 24, 19, 55, 25], [11, 45, 15, 46, 46, 16], [13, 145, 115, 6, 146, 116], [14, 74, 46, 23, 75, 47], [44, 54, 24, 7, 55, 25], [59, 46, 16, 1, 47, 17], [12, 151, 121, 7, 152, 122], [12, 75, 47, 26, 76, 48], [39, 54, 24, 14, 55, 25], [22, 45, 15, 41, 46, 16], [6, 151, 121, 14, 152, 122], [6, 75, 47, 34, 76, 48], [46, 54, 24, 10, 55, 25], [2, 45, 15, 64, 46, 16], [17, 152, 122, 4, 153, 123], [29, 74, 46, 14, 75, 47], [49, 54, 24, 10, 55, 25], [24, 45, 15, 46, 46, 16], [4, 152, 122, 18, 153, 123], [13, 74, 46, 32, 75, 47], [48, 54, 24, 14, 55, 25], [42, 45, 15, 32, 46, 16], [20, 147, 117, 4, 148, 118], [40, 75, 47, 7, 76, 48], [43, 54, 24, 22, 55, 25], [10, 45, 15, 67, 46, 16], [19, 148, 118, 6, 149, 119], [18, 75, 47, 31, 76, 48], [34, 54, 24, 34, 55, 25], [20, 45, 15, 61, 46, 16]],
                c = function (a, b) {
                    var e = {};
                    e.totalCount = a;
                    e.dataCount = b;
            ...
            a.getRSBlocks = function (a, b) {
                ...
                for (var f = e.length / 3, h = [], k = 0; k < f; k += 1) for (var n = e[3 * k + 0], p = e[3 * k + 1], r = e[3 * k + 2], l = 0; l < n; l += 1) h.push(c(p, r));
                return h
            };
            return a
        }(), v = function () {
            ...
            var b = 0, c = 0, a = 0, d = "", f = {}, g = function (a) {
                if (!(0 > a)) {
                    if (26 > a) return 65 + a;
            ...
            f.flush = function () {
                ...
                if (0 != a % 3) for (var e = 3 - a % 3, f = 0; f < e; f += 1) d += "="
            };
            f.toString = function () {
                return d
            };
            ...
            return {
                setPixel: function (c, d, f) {
                    ...
                    for (var p = 0, q = String.fromCharCode(a[p]), p = p + 1; p < a.length;) {
                        var r = String.fromCharCode(a[p]), p = p + 1;
            ...
            for (var f = z(b, c), g = 0; g < c; g += 1) for (var e = 0; e < b; e += 1) f.setPixel(e, g, a(e, g));
            a = x();
            f.write(a);
            f = w();
            a = a.toByteArray();
