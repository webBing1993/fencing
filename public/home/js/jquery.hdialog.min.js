    ...
    methods = {
        ...
        open: function (a, b) {
            if(isRun){
                ...
                0 != a.closeHide && (closeBtnTpl = '<a id="HCloseBtn" title="\u5173\u95ed" style="width:24px;height:24px;line-height:24px;display:inline-block;cursor:pointer;background-color:' + t + ';color:#fff;font-size:1.4em;text-align:center;position:absolute;top:0;right:8px;z-index: 99999999;"><span style="width:24px;height:24px;display:inline-block;"><img src="/home/images/icon_04.png" id="close"></span></a>');
